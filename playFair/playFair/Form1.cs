...
namespace playFair
{
    public partial class Form1 : Form
    {
        ...
        {
            //String text = "BALLOON";
            ////string cipherText = PlayFair.Encipher(text, "MONARCHY");
            //String cipherText = PlayFair_encrypt(text, "MONARCHY");

            //MessageBox.Show("After Decryption : "+ cipherText);
            //String plainText = PlayFair_decrypt(cipherText, "MONARCHY");
            //MessageBox.Show("After Decryption : " + plainText);
        }
        String PlayFair_encrypt(String str , String key)
        {
        ...
        String PlayFair_decrypt(String str ,String key )
        {
            //convert the whole message into capital letters .. because  the matrix is capital letters
            StringBuilder tmp_str = new StringBuilder(str.ToUpper());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            String plainText = plain_text.Text;

            result_text.Text = PlayFair_encrypt(plainText , key);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            result_text.Text = PlayFair_decrypt(plainText, key);
